...
">
        ...
        <div class="dot_crsl fb_cmnts col-3 feedback_comments" style="max-width: 230px; height: 100px">
            ...
            <div class="dots_ctr" style="width: 100%">
                <div class="dots">
                    {foreach from=$feedback_comments item=feedback_comment name=dots}<span onclick="select_feedback(this,{$smarty.foreach.dots.index|escape:'htmlall':'UTF-8'});" class="feedback_dot{if $smarty.foreach.dots.index == 0} feedback_dot_selected{/if}"></span>{/foreach}
                </div>
            </div>
        </div>
        {/if}
